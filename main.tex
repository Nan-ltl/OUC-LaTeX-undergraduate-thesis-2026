...
\setlist{nosep} 
\usepackage[%
colorlinks=false,        % 启用颜色链接（自动去掉边框）
linkcolor=black,        % 内部链接（目录、交叉引用）为黑色
citecolor=black,        % 参考文献引用为黑色
urlcolor=black,         % URL链接为黑色
filecolor=black,        % 文件链接为黑色
pdfborder={0 0 0}       % 额外确保边框为0
]{hyperref}
\frenchspacing
